                    ...
                    {LAYOUTS.map((layout, index) => (
                        <AnimateOnScroll key={layout.id} delay={index * 100}>
                            <div className="group relative flex flex-col bg-[var(--domu-surface-1)] border border-white/5 rounded-3xl overflow-hidden hover:border-[#005BFF]/30 transition-all duration-700">
                                ...
                                {layout.isPopular && (
                                    <div className="absolute top-6 right-6 z-20 bg-[#005BFF] text-white text-[9px] font-black uppercase tracking-widest px-4 py-2 rounded-full shadow-lg">
                                        Mais Vendido
                                    </div>
                                )}
                                ...
                                <div className="p-6 md:p-10">
                                    <span className={`inline-block px-3 py-1 rounded-full font-black text-[9px] uppercase tracking-[0.15em] mb-5 ${
                                        ...
                                        'bg-[#005BFF]/10 text-[#005BFF]'
                                    }`}>
                                        {layout.category}
                                    </span>
                                    <h3 className="text-white font-black text-2xl  mb-6 group-hover:text-[#005BFF] transition-colors">
                                        {layout.name}
                                    </h3>
                                    ...
                                    <div className="flex items-center justify-between mt-auto pt-8 border-t border-white/5">
                                        ...
                                        <button className="flex items-center justify-center w-12 h-12 bg-white/5 border border-white/10 rounded-2xl hover:bg-[#005BFF] hover:border-[#005BFF] text-white transition-all duration-500">
